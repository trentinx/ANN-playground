...
class connection:
    ...
    def updt(self, rate) :
        ...
        self.sumgrad=self.sumgrad+grad**2
...
class layered_network:
    ...
    def cyclelearn(self, Input, expected, rate, nb):
        Err=[]
        for i in range(nb):
            Err.append(self.multilearn(Input, expected, rate))
        return Err
...
if __name__ == "__main__":
    ...
    listerr=L.cyclelearn(inputs, out, 10**(-1), 1000)  # Taux d'apprentissage réduit et 5000 itérations
